...
export default function Hero() {
    return (
        <section className="relative pt-32 pb-24 overflow-hidden bg-gradient-to-br from-gray-50 via-white to-blue-50 min-h-screen flex items-center">
            ...
            <div className="absolute top-20 -left-40 w-96 h-96 bg-blue-200 rounded-full mix-blend-multiply filter blur-3xl opacity-30 animate-blob pointer-events-none"></div>
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
                ...
                >
                    ...
                    <span className="bg-gradient-to-r from-blue-600 to-gray-600 bg-clip-text text-transparent font-semibold text-sm">
                        v1.0 is now live
                    </span>
                </motion.div>
                ...
                >
                    <a href="/login" className="group bg-gray-900 text-white px-10 py-4 rounded-2xl font-bold text-lg hover:shadow-2xl hover:shadow-gray-500/30 transition-all duration-300 flex items-center justify-center gap-3 transform hover:-translate-y-1">
                ...
                >
                    <div className="absolute -inset-4 bg-gradient-to-r from-blue-600 via-purple-600 to-indigo-600 rounded-[2.5rem] blur-2xl opacity-20 animate-pulse"></div>
